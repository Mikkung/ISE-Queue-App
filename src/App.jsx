...
function StudentView({ ticketId, queues, onFeedback, onNewTicket, staff, lang, t }) {
  ...
  // 🔥 ย้ายคำสั่งที่เกี่ยวกับ Hook มาไว้ก่อน early return ป้องกันปัญหาจอดับ (Rules of Hooks)
  ...
  // 🔥 ถ้าไม่พบคิว หรือสถานะถูกเปลี่ยน ค่อยโชว์หน้าใหม่หลังจากโหลดคำสั่งด้านบนครบหมดแล้ว
  if (!myTicket) {
    return (
